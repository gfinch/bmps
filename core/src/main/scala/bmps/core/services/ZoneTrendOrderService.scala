...
//                         addOrder(OrderType.Short, currentCandle, zones, 0, state, 2.0, 1.0)
...
//                     (lastCandle.close, lastCandle.close + bufferTicks)
...
//                     (lastCandle.close - bufferTicks, lastCandle.close)
